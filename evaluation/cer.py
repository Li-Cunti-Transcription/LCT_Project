...
# scores after cleaning elisions
gpt_cleaned = []
with open("evaluation/gpt_transcriptions/gpt_cleaned.txt", "r", encoding="utf-8") as f:
    for line in f:
        gpt_cleaned.append(line)

print(len(gpt_cleaned))

wer_gpt_cleaned = pywer.wer(references, gpt_cleaned)
cer_gpt_cleaned = pywer.cer(references, gpt_cleaned)
print("GPT WER and CER after cleaning elisions:\n", f"WER: {wer_gpt_cleaned:.2f}, CER: {cer_gpt_cleaned:.2f}")
...
wer_cleaned_page_2 = pywer.wer(ref_page_2, gpt_cleaned_page_2)
cer_cleaned_page_2 = pywer.cer(ref_page_2, gpt_cleaned_page_2)
print("GPT WER and CER after cleaning elisions for page 2:\n", f"WER: {wer_cleaned_page_2:.2f}, CER: {cer_cleaned_page_2:.2f}")
